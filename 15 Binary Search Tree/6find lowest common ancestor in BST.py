...
def Lowest_common_ancestor_bst(root,val1,val2):
    if root==None:
        return None
    if root.data<val1 and root.data<val2:
        return Lowest_common_ancestor_bst(root.right, val1, val2)
    elif root.data>val1 and root.data>val2:
        return Lowest_common_ancestor_bst(root.left, val1, val2)
    else:
        return root.data
...
def fun():
    ...
    display(root)
    print()
    print(Lowest_common_ancestor_bst(root,30,90))
fun()